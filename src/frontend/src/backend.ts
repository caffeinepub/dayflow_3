...
export class Backend implements backendInterface {
    ...
    async addContact(arg0: BirthdayContact): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllContacts(arg0: Principal): Promise<Array<BirthdayContact>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllContacts(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listContacts(): Promise<Array<BirthdayContact>> {
        if (this.processError) {
            try {
